...
import com.sarangcode.projecttama.utilities.SunshineDateUtils;
import com.sarangcode.projecttama.utilities.SunshineWeatherUtils;
import com.sarangcode.projecttama.R;
import com.sarangcode.projecttama.WeatherFragment;
...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
         ...
         * Weather Icon *
         ****************/
        int weatherId = mCursor.getInt(WeatherFragment.INDEX_WEATHER_CONDITION_ID);
        int weatherImageId;
        ...
        long dateInMillis = mCursor.getLong(WeatherFragment.INDEX_WEATHER_DATE);
        ...
        double highInCelsius = mCursor.getDouble(WeatherFragment.INDEX_WEATHER_MAX_TEMP);
         /*
        ...
        double lowInCelsius = mCursor.getDouble(WeatherFragment.INDEX_WEATHER_MIN_TEMP);
         /*
          * If the user's preference for weather is fahrenheit, formatTemperature will convert
          * the temperature. This method will also append either °C or °F to the temperature
          * String.
